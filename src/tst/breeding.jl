...
"""
    function test_breeding_sim_base()
---
This is a copy of above function, except
1. the base was replace with a simulated one.
2. figures were drawn somewhere else
"""
function test_breeding_sim_base()
    Parameters = Dict(:nSire=> 125,
                      :nDam => 250, # male:female = 1:2
    ...
    plot!(mp, label="Random mating")
    savefig("doc/fig/test-breeding-v4.pdf")
end
